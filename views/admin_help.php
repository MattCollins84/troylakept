      ...
      <table class="table table-bordered">
        ...
        <tbody>
          <tr>
            ...
            <td><?=$pd->text("this is the first line\n\nthis is the second line");?></td>
          </tr>
          <tr>
            <td>Header</td>
            <td># Header</td>
            <td><?=$pd->text("# Header");?></td>
          </tr>
          <tr>
            <td>Sub-Header</td>
            <td>## Header<br /><br /><br /><br />You can go all the way down to ###### Header</td>
            <td><?=$pd->text("## Header");?><br /><?=$pd->text("###### Header");?></td>
          </tr>          
          <tr>
            <td>Bold text</td>
            <td>**make this text bold**</td>
            <td><?=$pd->text("**make this text bold**");?></td>
          </tr>
          <tr>
            <td>Italic/emphasis on text</td>
            <td>_emphasis_</td>
            <td><?=$pd->text("_emphasis_");?></td>
          </tr>
          <tr>
            <td>Block quote</td>
            <td>&gt; Some important words</td>
            <td><?=$pd->text("> Some important words");?></td>
          </tr>
          <tr>
            <td>Add a link</td>
            <td>[This link](http://example.net/)</td>
            <td><?=$pd->text("[This link](http://example.net/)");?></td>
          </tr>
          <tr>
            <td>Bullet List</td>
